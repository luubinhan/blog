...
;(function(window) {
	...
	var body = document.body,
		...
		filterControl = [].slice.call(document.querySelectorAll('.badge-filter')),
	...
	function generateEffect(){
		/*
			Run randome effect // an.luu			
			 */
		var effectName = '';
		effectNumber = Math.floor((Math.random() * 15) + 1);
		switch(effectNumber) {
			case 1:
				effectName ='Hapi';
				break;
	...
	function initEvents() {
		...
		filterControl.forEach(function(ctrl) {
			ctrl.addEventListener('click', applyFx);
		});
