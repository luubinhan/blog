    ...
    return (
      <div className="master">
        <Helmet
          ...
          meta={[
            { name: 'description', content: `${config.siteTitle} ${config.siteTitleAlt}` },
          ...
          <div className="page-about">
            <div className="about-header">
              ...
              <ul className="nav nav-pills">
                <li>
                  <a role='button' aria-pressed="false" tabIndex="0" onClick={() => this.handleSelect(1)}>Vietnamese</a>
                </li>
                <li>
                  <a role='button' aria-pressed="false" tabIndex="0" onClick={() => this.handleSelect(2)}>English</a>
                </li>
              </ul>
            </div>
        ...
        <div className="aside" style={{backgroundImage: `url(${bgSidebar[7]})`}}>
