	...
	render() {  		
		return (
			<div className="master">
							...
							<div className="single-post-container">
								{this.state.selectedTab === 1 &&
									<div className="post-content">
										...
										<p>
											Luôn luôn là bị mắc lỗi phát âm tiếng anh, mình đâm đơn vào các công ty nước ngoài nơi có phỏng vấn tiếng anh để thử sức. Công ty đầu tiên làm game ở ETown, chị HR mới hỏi mấy câu đơn giản tên tuổi, quê quán, mình lóng nga lóng ngóng không biết trả lời sau, thấy bí quá chị nói "thôi để chị hỏi tiếng Việt"
										</p>
										<p>
				...
				<div className="aside" style={{backgroundImage: `url(${BG_SIDEBAR[8]})`}}>
